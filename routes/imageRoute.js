...
router.route("/Get")
	.post(function(req, res){
		...
		if(req.body.user_type === "commonuser"){
			...
			.then(function(newUser){
				console.log(newUser);
				gfs.files.findOne({ filename: newUser.fileName}, (err, file) => {
					// Check if file
			...
			db.profileimg.findOne({"workerImg.Phone_no":req.body.Phone_no})
			.then(function(newUser){
				console.log(newUser);
				gfs.files.findOne({ filename: newUser.fileName}, (err, file) => {
					// Check if file
			...
			db.profileimg.findOne({"EnterpiceImg.Email_id":req.body.Email_id})
			.then(function(newUser){
				console.log(newUser);
				gfs.files.findOne({ filename: newUser.fileName}, (err, file) => {
					// Check if file
